...
namespace WindowsFormsApp8
{
	...
	public bool IsLeap(int year)
     ...
     public   int DayInYear(int year, int month, int day)
        {
            //int _day = 0;
            int []DAY = new int[12]{ 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
            if (IsLeap(year))
                DAY[1] = 29;
       ...
       public int DaysBetween2Day(int year1, int month1, int day1, int year2, int month2, int day2)
        {
     ...
     public   int NextBirthday(int year1, int month1, int day1, int year2, int month2, int day2)
        {
            int days=0;
